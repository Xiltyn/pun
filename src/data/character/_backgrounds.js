		...
		"background": [
			{
				...
				"trait": [
					...
					{
						"name": "Equipment",
						"text": "A holy symbol (a gift to you when you entered the priesthood), a prayer book or prayer wheel, 5 sticks of incense, vestments, a set of common clothes, and a belt pouch containing 15 gp"
					},
					{
			...
			},
			{
				...
				"trait": [
					{
						"name": "Skill Proficiencies",
						"text": "Deception, Sleight of Hand"
					},
					{
						"name": "Tool Proficiencies",
						"text": "Disguise Kit, Forgery Kit"
					},
					{
						"name": "Equipment",
						"text": "A set of fine clothes, a disguise kit, tools of the con of your choice (ten stoppered bottles filled with colored liquid, a set of weighted dice, a deck of marked cards, or a signet ring of an imaginary duke), and a belt pouch containing 15 gp."
					},
					{
			...
			},
			{
				...
				"trait": [
					{
						"name": "Skill Proficiencies",
						"text": "Athletics, Insight"
					},
					{
						"name": "Languages",
						"text": "Any two of your choice"
					},
					{
						"name": "Equipment",
						"text": "A uniform in the style of your unit and indicative of your rank, a horn with which to summon help, a set of manacles, and a pouch containing 10 gp."
					},
					{
			...
			},
			{
				...
				"trait": [
					{
						"name": "Skill Proficiencies",
						"text": "History, Insight"
					},
					{
						"name": "Tool Proficiencies",
						"text": "One type of artisan's tools"
					},
					{
						"name": "Languages",
						"text": "Dwarvish or one of your choice if you already speak Dwarvish"
					},
					{
						"name": "Equipment",
						"text": "A set of artisan's tools with which you are proficient, a maker's mark chisel used to mark your handiwork with the symbol of the clan of crafters you learned your skill from, a set of traveler's clothes, and a pouch containing 5 gp and a gem worth 10 gp."
					},
					{
						"name": "Feature: Respect of the Stout Folk",
						"text": [
							"As well respected as clan crafters are among outsiders, no one esteems them quite so highly as dwarves do. You always have free room and board in any place where shield dwarves or gold dwarves dwell, and the individuals in such a settlement might vie among themselves to determine who can offer you (and possibly your companions) the finest accomodations and assistance.",
							"Source: Sword Coast Adventurer's Guide, page 145"
						]
					}
				]
			},
			{
				...
				"trait": [
					{
						"name": "Skill Proficiencies",
						"text": "History, plus your choice of one from among Arcana, Nature, and Religion"
					},
					{
						"name": "Languages",
						"text": "Languages: any two of your choice"
					},
					{
						"name": "Equipment",
						"text": "The scholar's robes of your cloister, a writing kit (small pouch with a quill, ink, folded parchment, and a small penknife), a borrowed book on the subject of your current study, and a pouch containing 10 gp."
					},
					{
			...
			},
			{
				...
				"trait": [
					...
					{
						"name": "Equipment",
						"text": "A set of fine clothes and a pouch containing 5 gp."
					},
					{
			...
			},
			{
				...
				"trait": [
					{
						"name": "Skill Proficiencies",
						"text": "Deception, Stealth"
					},
					{
						"name": "Tool Proficiencies",
						"text": "One type of gaming set, thieves' tools"
					},
					{
						"name": "Equipment",
						"text": "A crowbar, a set of dark common clothes including a hood, and a belt pouch containing 15 gp"
					},
					{
			...
			},
			{
				...
				"trait": [
					{
						"name": "Skill Proficiencies",
						"text": "Acrobatics, Performance"
					},
					{
						"name": "Tool Proficiencies",
						"text": "Disguise kit, one type of musical instrument"
					},
					{
						"name": "Equipment",
						"text": "A musical instrument (one of your choice), the favor of an admirer (love letter, lock of hair, or trinket), a costume, and a belt pouch containing 15 gp"
					},
					{
			...
			},
			{
				...
				"trait": [
					{
						"name": "Skill Proficiencies",
						"text": "Insight and one Intelligence, Wisdom, or Charisma skill of your choice, as appropriate to your faction"
					},
					{
						"name": "Languages",
						"text": "Any two of your choice"
					...
					{
						"name": "Equipment",
						"text": "Badge or emblem of your faction, a copy of a seminal faction text (or code-book for a covert faction), a set of common clothes, and a pouch containing 15 gp."
					},
					{
						"name": "Feature: Safe Haven",
						"text": [
							"As a faction agent, you have access to a secret network of supporters and operatives who can provide assistance on your adventures. You know a set of secret signs and passwords you can use to identify such operatives, who can provide you with access to a hidden safe house, free room and board, or assistance in finding information. These agents never risk their lives for you or risk revealing their true identities.",
							"Source: Sword Coast Adventurer's Guide, page 147"
						]
					}
				]
			},
			{
				...
				"trait": [
					{
						"name": "Skill Proficiencies",
						"text": "Insight, Perception"
					},
					{
						"name": "Tool Proficiencies",
						"text": "Any one musical instrument or gaming set of your choice, likely something native to your homeland"
					},
					{
						"name": "Languages",
						"text": "Any one of your choice"
					},
					{
						"name": "Equipment",
						"text": "One set of traveler's clothes, any one musical instrument or gaming set you are proficient with, poorly wrought maps from your homeland that depict where you are in Faerûn, a small piece of jewelry worth 10 gp in the style of your homeland's craftsmanship, and a pouch containing 5 gp."
					},
					{
						...
						"text": [
							...
							"Source: Sword Coast Adventurer's Guide, page 148"
						]
					}
				]
			},
			{
				...
				"trait": [
					{
						"name": "Skill Proficiencies",
						"text": "Animal Handling, Survival"
					},
					{
						"name": "Tool Proficiencies",
						"text": "One type of artisan's tools, vehicles (land)"
					},
					{
						"name": "Equipment",
						"text": "A set of artisan's tools (one of your choice), a shovel, an iron pot, a set of common clothes, and a belt pouch containing 10 gp"
					},
					{
						"name": "Feature: Rustic Hospitality",
						"text": "Since you come from the ranks of the common folk, you fit in among them with ease. You can find a place to hide, rest, or recuperate among other commoners, unless you have shown yourself to be a danger to them. They will shield you from the law or anyone else searching for you, though they will not risk their lives for you."
					}
				]
			},
			{
				...
				"trait": [
					...
					{
						"name": "Equipment",
						"text": "A set of artisan's tools (one of your choice), a letter of introduction from your guild, a set of traveler's clothes, and a belt pouch containing 15 gp"
					},
					{
			...
			},
			{
				...
				"trait": [
					...
					{
						"name": "Languages",
						"text": "One of your choice"
					},
					{
						"name": "Equipment",
						"text": "A scroll case stuffed full of notes from your studies or prayers, a winter blanket, a set of common clothes, an herbalism kit, and 5 gp"
					},
					{
			...
			},
			{
				...
				"trait": [
					{
						"name": "Skill Proficiencies",
						"text": "Survival, plus one from among Arcana, History, and Religion"
					},
					{
						"name": "Languages",
						"text": "Any one of your choice"
					...
					{
						"name": "Equipment",
						"text": "Your inheritance, a set of traveler's clothes, any items with which you are proficient, and a pouch containing 15 gp."
					},
					{
						...
						"text": [
							...
							"Source: Sword Coast Adventurer's Guide, page 150"
						]
					}
				]
			},
			{
				"name": "Investigator",
				"proficiency": "Insight, Investigation",
				"trait": [
					{
						"name": "Skill Proficiencies",
						"text": "Insight, Investigation"
					},
					{
						"name": "Languages",
						"text": "Any two of your choice"
			...
			},
			{
				...
				"trait": [
					{
						"name": "Skill Proficiencies",
						"text": "Persuasion, plus one from among Arcana, History, Nature, and Religion, as appropriate for your order"
					},
					{
						"name": "Tool Proficiencies",
						"text": "Your choice of a gaming set or a musical instrument"
					...
					{
						"name": "Equipment",
						"text": "One set of traveler's clothes, a signet, banner, or seal representing your place or rank in the order, and a pouch containing 10 gp."
					},
					{
						...
						"text": [
							...
							"Source: Sword Coast Adventurer's Guide, page 151"
						]
					}
				]
			},
			{
				...
				"proficiency": "Athletics, Persuasion",
				"trait": [
					{
						"name": "Skill Proficiencies",
						"text": "Athletics, Persuasion"
					},
					{
						"name": "Tool Proficiencies",
						"text": "One type of gaming set, vehicles (land)"
					},
					{
						"name": "Equipment",
						"text": "A uniform of your company (traveler's clothes in quality), an insignia of your rank, a gaming set of your choice, and a pouch containing the remainder of your last wages (10 gp)."
					},
					{
						...
						"text": [
							...
							"Source: Sword Coast Adventurer's Guide, page 152"
						]
					}
				]
			},
			{
				...
				"trait": [
					{
						"name": "Skill Proficiencies",
						"text": "History, Persuasion"
					},
					{
						"name": "Tool Proficiencies",
						"text": "One type of gaming set"
					},
					{
						"name": "Languages",
						"text": "One of your choice"
					...
					{
						"name": "Equipment",
						"text": "A set of fine clothes, a signet ring, a scroll of pedigree, and a purse containing 25 gp"
					},
					{
			...
			},
			{
				...
				"trait": [
					{
						"name": "Skill Proficiencies",
						"text": "Athletics, Survival"
					},
					{
						"name": "Tool Proficiencies",
						"text": "One type of musical instrument"
					},
					{
						"name": "Languages",
						"text": "One of your choice"
					...
					{
						"name": "Equipment",
						"text": "A staff, a hunting trap, a trophy from an animal you killed, a set of traveler's clothes, and a belt pouch containing 10 gp"
					},
					{
			...
			},
			{
				...
				"trait": [
					...
					{
						"name": "Equipment",
						"text": "A bottle of black ink, a quill, a small knife, a letter from a dead colleague posing a question you have not yet been able to answer, a set of common clothes, and a belt pouch containing 10 gp"
					},
					{
			...
			},
			{
				...
				"trait": [
					{
						"name": "Skill Proficiencies",
						"text": "Athletics, Perception"
					},
					{
						"name": "Tool Proficiencies",
						"text": "Navigator's tools, vehicles(water)"
					},
					{
						"name": "Equipment",
						"text": "A belaying pin (dub), 50 feet of silk rope, a lucky charm such as a rabbit foot or a small stone with a hole in the center (or you may roll for a random trinket on the Trinkets table in chapter 5), a set of common clothes, and a belt pouch containing 10 gp"
					},
					{
			...
			},
			{
				...
				"trait": [
					...
					{
						"name": "Equipment",
						"text": "An insignia of rank, a trophy taken from a fallen enemy (a dagger, broken blade, or piece of a banner), a set of bone dice or deck of cards, a set of common clothes, and a belt pouch containing 10 gp"
					},
					{
			...
			},
			{
				...
				"trait": [
					{
						"name": "Skill Proficiencies",
						"text": "Choose two from among Deception, Insight, Persuasion, and Stealth"
					},
					{
						"name": "Tool Proficiencies",
						"text": "Choose two from among one type of gaming set, one musical instrument, and thieves's tools"
					},
					{
						"name": "Equipment",
						"text": "A set of clothes appropriate to your duties and a pouch containing 20 gp "
					},
					{
						"name": "Feature: Ear to the Ground",
						"text": [
							"You are in frequent contact with people in the segment of society that your chosen quarries move through. These people might be associated with the criminal underworld, the rough-and-tumble folk of the streets, or members of high society. This connection comes in the form of a contact in any city you visit, a person who provides information about the people and places of the local area.",
							"Source: Sword Coast Adventurer's Guide, page 153"
						]
					}
				]
			},
			{
				...
				"trait": [
					{
						"name": "Skill Proficiencies",
						"text": "Sleight of Hand, Stealth"
					},
					{
						"name": "Tool Proficiencies",
						"text": "Disguise Kit, thieves' tools"
					},
					{
						"name": "Equipment",
						"text": "A small knife, a map of the city you grew up in, a pet mouse, a token to remember your parents by, a set of common clothes, and a belt pouch containing 10 gp"
					},
					{
			...
			},
			{
				...
				"trait": [
					...
					{
						"name": "Tool Proficiencies",
						"text": "One type of musical instrument or artisan's tools"
					},
					{
						"name": "Equipment",
						"text": "A hunting trap, a totemic token or set of tattoos marking your loyalty to Uthgar and your tribal totem, a set of traveler's clothes, and a pouch containing 10 gp."
					},
					{
			...
			},
			{
				...
				"trait": [
					...
					{
						"name": "Tool Proficiencies",
						"text": "One type of gaming set or one musical instrument"
					},
					{
						"name": "Equipment",
						"text": "A set of fine clothes, a signet ring or brooch, a scroll of pedigree, a skin of fine zzar or wine, and a purse containing 20 gp."
					},
					{
						...
						"text": [
							...
							"Source: Sword Coast Adventurer's Guide, page 154"
						]
					}
				]
			},
			{
				...
				"trait": [
					...
					{
						"name": "Tool Proficiencies",
						"text": "One type of gaming set, thief's tools"
					},
					{
						"name": "Equipment",
						"text": "A crowbar, a set of dark common clothes including a hood, and a belt pouch containing 15 gp"
					},
					{
						...
						"text": "You have a reliable and trustworthy contact who acts as your liaison to a network of other spies. You know how to get messages to and from your contact, even over great distances; specifically, you know the local messengers, corrupt caravan masters, and seedy sailors who can deliver messages for you."
					}
				]
			},
			{
				...
				"trait": [
					...
					{
						"name": "Equipment",
						"text": "An inexpensive but unusual weapon, such as a trident or net (one of your choice), the favor of an admirer (love letter, lock of hair, or trinket), a costume, and a belt pouch containing 15 gp"
					},
					{
						"name": "Feature: By Popular Demand",
						"text": "You can find a place to perform in any place that features combat for entertainment-perhaps a gladiatorial arena or secret pit fighting club. In such an area, you receive free lodging and food of a modest or comfortable standard (depending on the quality of the establishment), as long as you perform each night. In addition, your performance makes you something of a local figure. When strangers recognize you in a town where you have performed, they typically take a liking to you."
					}
				]
			},
			{
				...
				"trait": [
					...
					{
						"name": "Tool Proficiencies",
						"text": "Navigator's Tools or an additional language"
					},
					{
						"name": "Equipment",
						"text": "A mule and cart, a letter of introduction from your guild, a set of traveler's clothes, and a belt pouch containing 15 gp"
					},
					{
						"name": "Feature: Guild Membership",
						"text": [
			...
			},
			{
				...
				"trait": [
					...
					{
						"name": "Equipment",
						"text": "A banner or other token from a noble lord or lady to whom you have given your heart, a set of fine clothes, a signet ring, a scroll of pedigree, and a purse containing 25 gp"
					},
					{
			...
			},
			{
				...
				"trait": [
					...
					{
						"name": "Skill Proficiencies",
						"text": "Chose two of Arcana, Investigation, Religion, or Survival"
					},
					{
						"name": "Languages",
						"text": "Choose one exotic language (Abyssal, Celestial, Deep Speech, Draconic, Infernal, Primordial, Sylvan, or Undercommon)"
					},
					{
					...
					{
						"name": "Equipment",
						"text": "Monster hunter's pack, one trinket of special significance (choose one or roll on the Gothic Trinkets table)"
					}
				]
			}
		]
