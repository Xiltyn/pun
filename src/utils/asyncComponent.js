...
export default function asyncRoute( getComponent ) {
	return class AsyncComponent extends React.Component {
		...
		componentWillUnmount() {
			...
			// AsyncComponent.scrollPositions[key] = [window.scrollX, window.scrollY];  // <-- Only supported in CSSOM
			// browsers
			AsyncComponent.scrollPositions[ key ] = [ window.pageXOffset, window.pageYOffset ]; // IE9+ pageXOffset is
																								// alias of scrollX
